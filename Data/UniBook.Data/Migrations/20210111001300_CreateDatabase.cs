    ...
    public partial class CreateDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_YearIssueds", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MessagesRoom", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MessagesRoom_Messages_MessageId",
                        column: x => x.MessageId,
                        principalTable: "Messages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MessagesRoom_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MessagesRoom_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YearIssuedId = table.Column<int>(nullable: true),
                    Votes = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Books_YearIssueds_YearIssuedId",
                        column: x => x.YearIssuedId,
                        principalTable: "YearIssueds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostId = table.Column<int>(nullable: false),
                    UserId = table.Column<string>(nullable: false),
                    TypeVote = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessagesRoom_IsDeleted",
                table: "MessagesRoom",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_MessagesRoom_MessageId",
                table: "MessagesRoom",
                column: "MessageId");

            migrationBuilder.CreateIndex(
                name: "IX_MessagesRoom_RoomId",
                table: "MessagesRoom",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_MessagesRoom_UserId",
                table: "MessagesRoom",
                column: "UserId");
